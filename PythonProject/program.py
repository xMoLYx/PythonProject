...
idLabel = Label(program, text = 'Student ID', font = ('Codec Pro Extra Bold', 20, 'bold'), bd = 0, fg = 'white', bg = '#9340FF')
firstnameLabel = Label(program, text = 'Firstname', font = ('Codec Pro Extra Bold', 20, 'bold'), bd = 0, fg = 'white', bg = '#9340FF')
lastnameLabel = Label(program, text = 'Lastname', font = ('Codec Pro Extra Bold', 20, 'bold'), bd = 0, fg = 'white', bg = '#9340FF')
addressLabel = Label(program, text = 'Address', font = ('Codec Pro Extra Bold', 20, 'bold'), bd = 0, fg = 'white', bg = '#9340FF')
phoneLabel = Label(program, text = 'Phone', font = ('Codec Pro Extra Bold', 20, 'bold'), bd = 0, fg = 'white', bg = '#9340FF')

idLabel.place(x = 217, y = 200)
...
idEntry = Entry(program, width = 25, font = ('Codec Pro Extra Bold', 20, 'bold'), bd = 0, fg = 'white', bg = '#977BBD', textvariable = ph1)
firstnameEntry = Entry(program, width = 25, font = ('Codec Pro Extra Bold', 20, 'bold'), bd = 0, fg = 'white', bg = '#977BBD', textvariable = ph2)
lastnameEntry = Entry(program, width = 25, font = ('Codec Pro Extra Bold', 20, 'bold'), bd = 0, fg = 'white', bg = '#977BBD', textvariable = ph3)
addressEntry = Entry(program, width = 25, font = ('Codec Pro Extra Bold', 20, 'bold'), bd = 0, fg = 'white', bg = '#977BBD', textvariable = ph4)
phoneEntry = Entry(program, width = 25, font = ('Codec Pro Extra Bold', 20, 'bold'), bd = 0, fg = 'white', bg = '#977BBD', textvariable = ph5)
...
addButton = Button(program, text = 'Add', font = ('Codec Pro Extra Bold', 20, 'bold underline'), fg = 'white', bg= '#269F53', cursor = 'hand2', activebackground = 'white', activeforeground = 'white', width = 10, bd = 5, pady = 7, command = add)
updateButton = Button(program, text = 'Update', font = ('Codec Pro Extra Bold', 20, 'bold underline'), bg = '#49778B', fg = 'white', cursor = 'hand2', activebackground = 'white', activeforeground = 'white', width = 10, bd = 5, pady = 7, command = update)
deleteButton = Button(program, text = 'Delete', font = ('Codec Pro Extra Bold', 20, 'bold underline'), bg = '#8B4949', fg = 'white', cursor = 'hand2', activebackground = 'white', activeforeground = 'white', width = 10, bd = 5, pady = 7, command = delete)
searchButton = Button(program, text = 'Search', font = ('Codec Pro Extra Bold', 20, 'bold underline'), bg = '#8B8449', fg = 'white', cursor = 'hand2', activebackground = 'white', activeforeground = 'white', width = 10, bd = 5, pady = 7, command = search)
resetButton = Button(program, text = 'Reset', font = ('Codec Pro Extra Bold', 20, 'bold underline'), bg = '#88498B', fg = 'white', cursor = 'hand2', activebackground = 'white', activeforeground = 'white', width = 10, bd = 5, pady = 7, command = reset)
selectButton = Button(program, text = 'Select', font = ('Codec Pro Extra Bold', 20, 'bold underline'), bg = '#697DAF', fg = 'white', cursor = 'hand2', activebackground = 'white', activeforeground = 'white', width = 10, bd = 5, pady = 7, command = select)

addButton.place(x= 757, y = 200)
updateButton.place(x= 757, y = 280)
deleteButton.place(x= 757, y = 360)
searchButton.place(x= 950, y = 200)
